-- Variable are linked with servestate
-- Added logic for rewarding player a life when some threshold score is attained
        ...
        if brick.inPlay and self.ball:collides(brick) then
            ...
            gStateMachine:change('serve', {
                ...
                level = self.level
                     ...
                     if reward > self.rewardScore then
             if self.health <= 2 then 
            self.health = self.health + 1
        end
          self.rewardScore = self.rewardScore + 6000
end
