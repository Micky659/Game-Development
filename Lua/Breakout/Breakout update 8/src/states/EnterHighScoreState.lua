...
if love.keyboard.wasPressed('left') and highlightedChar > 1 then
	...
	gSounds['select']:play()
	elseif	
		love.keyboard.wasPressed('right') and highlightedChar < 3 then
	highlightedChar = highlightedChar + 1
	gSounds['select']:play()
end
...
elseif love.keyboard.wasPressed('down') then
	...
	function EnterHighScoreState:render()
		...
		love.graphics.printf('Your score: ' .. tostring(self.score), 0, 30, WINDOW_WIDTH, 'center')
		...
		love.graphics.printf('Press Enter to Confirm!', 0, WINDOW_HEIGHT - 18, WINDOW_WIDTH, 'center')
	end
